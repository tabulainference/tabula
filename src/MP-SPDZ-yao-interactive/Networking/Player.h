...
public:
  ...
  void send_to_and_writefile(int player,const octetStream& o, string name) const;
  ...
  void receive_player_and_readfile(int i, octetStream& o, string fname) const;
  ...
  virtual void receive_player_and_readfile(int i,FlexBuffer& buffer, string fname) const;  
